...
export const quotes: Quote[] = [
  ...
  {
    text: "Love is an untamed force. When we try to control it, it destroys us. When we try to imprison it, it enslaves us.",
    author: "Paulo Coelho"
  },
  {
  ...
  {
    text: "Time is too slow for those who wait, too swift for those who fear.",
  ...
  {
    text: "Great thoughts speak only to the thoughtful mind.",
  ...
  {
    text: "Be yourself. The world worships the original.",
  ...
  {
    text: "The only way to have a good life is to do work you're proud of.",
    author: "Paul Graham"
  },
  {
    text: "The more you know who you are, the less others' opinions matter.",
    author: "Unknown"
  },
  {
  ...
  {
    text: "Life is lived forward but understood backward.",
...
import { getRandomQuote, shouldUpdateQuote } from './utils/quoteUtils';
